...
> ([the docs federation](https://primmel.github.io/primmel-oiml-smart/primmel/14-live-twins/)).
...
- Multiple `start_event`s are normal &mdash; one per canvas diagram.
...
real standards models look in Primmel &mdash; model sizes, canvas
