...
Compliance in Primmel is built on **provisions** , statements of
requirement using the RFC 2119 modality vocabulary , bound to
data and traceable to source standard clauses via **references**.

## Primitives

### `reference` , cite a source clause
...
### `subject#N` , data-aware provisions
