...
# Audit , verify conformance against a reference

> **WHO THIS IS FOR**
> The **Audit** pillar is for **Auditors** , external assessors,
...
A compliance verdict , typically a report stating which
...
- **Statement of Applicability** , does the mapping cover every
...
- **Operational conformance** , do the records in `.pws/` actually
...
- [Compliance and measurement example](/examples/compliance-and-measurement)
  , the gateway edge `condition` expressions and
...
- [Implementation package walkthrough](/examples/implementation-package)
  , the showcase that demonstrates both kinds of audit input.
