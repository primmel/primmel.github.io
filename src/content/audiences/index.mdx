...
The same five roles recur at every rung of the ladder: in the language
(below), in the platform ([the platform page](/architecture/platform)),
and in each program — OIML SMART names them issuing authorities, test
laboratories, applicants, scheme operators, and NMIs
([the NMI section](https://primmel.github.io/primmel-oiml-smart/nmi/)).
