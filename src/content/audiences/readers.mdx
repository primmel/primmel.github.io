...
## The pitch &mdash; for everyone, starting here

**The world today.** Standards are the operating system of the
physical economy &mdash; every scale in a shop, every gas meter on a
wall, every certificate on a factory wall runs on them &mdash; and they
...
**What changes.** Eight words: **is, has, does** &mdash; and
...
machine-executable &mdash; the same artifact for the committee member,
the engineer, the auditor, and the runtime. This is not a claim; it is
proved &mdash; the system is closed (nothing escapes the eight terms),
...
*read* it &mdash; requirements with their tests attached, tests with
their evidence forms attached, every node one click from the clause it
came from. No install, no training: reading is the first rung of the
ladder, and it is genuinely readable.

**The proof.** The
[foundation volume](https://primmel.github.io/primmel-oiml-smart/foundation/)
carries the three theorems and their proofs, written to be checked by a
patient reader &mdash; no category theory required.

**Your next step.** Build [a first model](/docs/first-model) &mdash;
