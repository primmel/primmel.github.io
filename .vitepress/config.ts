      ...
      '/architecture/': [
        {
          ...
          items: [
            ...
            { text: 'Define', link: '/architecture/define' },
            { text: 'Reference', link: '/architecture/reference' },
            { text: 'Implement', link: '/architecture/implement' },
            { text: 'Operate', link: '/architecture/operate' },
            { text: 'Audit', link: '/architecture/audit' },
          ],
        },
        {
          text: 'Audiences',
          items: [
            { text: 'Publishers', link: '/architecture/audiences/publishers' },
            { text: 'Readers', link: '/architecture/audiences/readers' },
            { text: 'Implementers', link: '/architecture/audiences/implementers' },
            { text: 'Operators', link: '/architecture/audiences/operators' },
            { text: 'Auditors', link: '/architecture/audiences/auditors' },
          ],
        },
      ],
      '/examples/': [
